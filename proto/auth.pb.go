...
// session token and csrf token returned in response metadata
...
func (x *ProtectedRequest) GetUsername() string {
	if x != nil {
		return x.Username
	}
	return ""
...
const file_proto_auth_proto_rawDesc = "" +
	...
	"\amessage\x18\x01 \x01(\tR\amessage\".\n" +
	"\x10ProtectedRequest\x12\x1a\n" +
	"\busername\x18\x01 \x01(\tR\busername\"-\n" +
	"\x11ProtectedResponse\x12\x18\n" +
	...
	"\x06Logout\x12\x0e.LogoutRequest\x1a\x0f.LogoutResponse\x122\n" +
	"\tProtected\x12\x11.ProtectedRequest\x1a\x12.ProtectedResponseB\x0fZ\rgo_auth/protob\x06proto3"
...
var file_proto_auth_proto_goTypes = []any{
	...
	(*ProtectedRequest)(nil),  // 6: ProtectedRequest
	(*ProtectedResponse)(nil), // 7: ProtectedResponse
}
var file_proto_auth_proto_depIdxs = []int32{
	...
	6, // 3: Auth.Protected:input_type -> ProtectedRequest
	...
	7, // 7: Auth.Protected:output_type -> ProtectedResponse
